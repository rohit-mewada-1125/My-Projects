...
def search():
    ...
    if user:
        return ('workprogress.html', user=user)
    else:
        return ('error.html')        
...
def login():
    if request.method == 'POST':
        ...
        return ('userlogin.html', error='Invalid username or password')
...
def admin_dashboard():
    if 'admin_logged_in' in session:
        ...
        return ('admin_dashboard.html', username=username)
    else:
...
def adminpanel():
      ...
      return ('adminpanel.html', userdetails=userdetails)   

@app.route('/manageposts') 
def manageposts():
    all_posts = posts.query.all()
    return ('managepost.html', posts=all_posts)
...
def edit_post(post_id):
    ...
    return ('edit_post.html', post=post)
...
def report():
    if 'user_logged_in' in session:
        ...
        return ('report.html', username=username,  captcha=captcha)
...
def post_route(post_slug):
        ...
        return ("viewfraud.html", post=post)
...
def postnew():
    ...
    return ("postnew.html", postn=postn)
...
def home():
        ...
        return ('home.html' ,  plot_data=plot_data , plot1_data=plot1_data)
